...
func TestGroupCompactNativeHistogramE2e(t *testing.T) {
	...
	comp, err := tsdb.NewLeveledCompactor(ctx, reg, logger, []int64{1000, 3000}, nil, dedup.NewChunkSeriesMerger())
	testutil.Ok(t, err)
	...
	metas := createAndUpload(t, bkt, []blockgenSpec{
		{
			numHistograms: 100, mint: 500, maxt: 1000, extLset: extLabels, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "1"}},
				{{Name: "a", Value: "2"}, {Name: "b", Value: "2"}},
				{{Name: "a", Value: "3"}},
		...
		{
			numHistograms: 100, mint: 2000, maxt: 3000, extLset: extLabels, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "3"}},
				{{Name: "a", Value: "4"}},
				{{Name: "a", Value: "5"}},
		...
		// Due to TSDB compaction delay (not compacting fresh block), we need one more block to be pushed to trigger compaction.
		{
			numHistograms: 100, mint: 3000, maxt: 4000, extLset: extLabels, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "7"}},
			},
		},
		// Extra block for "distraction" for different resolution and one for different labels.
		{
			numHistograms: 100, mint: 5000, maxt: 6000, extLset: labels.Labels{{Name: "e1", Value: "2"}}, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "7"}},
			},
		},
		// Extra block for "distraction" for different resolution and one for different labels.
		{
			numHistograms: 100, mint: 4000, maxt: 5000, extLset: extLabels, res: 0,
			series: []labels.Labels{
				{{Name: "a", Value: "7"}},
			},
		},
		// Second group (extLabels2).
		{
			numHistograms: 100, mint: 2000, maxt: 3000, extLset: extLabels2, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "3"}},
				{{Name: "a", Value: "4"}},
				{{Name: "a", Value: "6"}},
		...
		{
			numHistograms: 100, mint: 0, maxt: 1000, extLset: extLabels2, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "1"}},
				{{Name: "a", Value: "2"}, {Name: "b", Value: "2"}},
				{{Name: "a", Value: "3"}},
		...
		// Due to TSDB compaction delay (not compacting fresh block), we need one more block to be pushed to trigger compaction.
		{
			numHistograms: 100, mint: 3000, maxt: 4000, extLset: extLabels2, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "7"}},
			},
		},
		...
		{
			numHistograms: 100, mint: 0, maxt: 499, extLset: extLabels, res: 124,
			series: []labels.Labels{
				{{Name: "a", Value: "1"}},
				{{Name: "a", Value: "2"}, {Name: "b", Value: "2"}},
				{{Name: "a", Value: "3"}},
...
func createBlock(t testing.TB, ctx context.Context, prepareDir string, b blockgenSpec) (id ulid.ULID, meta *metadata.Meta) {
	...
	} else if b.numHistograms != 0 {
		id, err = e2eutil.CreateHistogramBlock(ctx, prepareDir, b.series, b.numHistograms, b.mint, b.maxt, b.extLset, b.res, metadata.NoneFunc)
	} else {
