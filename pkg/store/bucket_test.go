...
func TestSeries_SeriesSortedWithoutReplicaLabels(t *testing.T) {
	tests := map[string]struct {
		...
		"use TSDB label as replica label": {
			...
			expectedSeries: []labels.Labels{
				labels.FromStrings("a", "1", "ext1", "0", "replica", "1", "z", "1"),
				labels.FromStrings("a", "1", "ext1", "0", "replica", "1", "z", "2"),
				labels.FromStrings("a", "1", "ext1", "0", "replica", "2", "z", "1"),
				labels.FromStrings("a", "1", "ext1", "0", "replica", "2", "z", "2"),
				labels.FromStrings("a", "1", "ext1", "1", "replica", "3", "z", "1"),
				labels.FromStrings("a", "1", "ext1", "1", "replica", "3", "z", "2"),
				labels.FromStrings("a", "2", "ext1", "0", "replica", "1", "z", "1"),
				labels.FromStrings("a", "2", "ext1", "0", "replica", "2", "z", "1"),
				labels.FromStrings("a", "2", "ext1", "1", "replica", "3", "z", "1"),
			},
		},
		"use external label as replica label": {
			...
			expectedSeries: []labels.Labels{
				unsortedLabelsFromStrings("a", "1", "replica", "1", "z", "1"),
				unsortedLabelsFromStrings("a", "1", "replica", "1", "z", "2"),
				unsortedLabelsFromStrings("a", "1", "replica", "2", "z", "1"),
				unsortedLabelsFromStrings("a", "1", "replica", "2", "z", "2"),
			},
		},
	}
