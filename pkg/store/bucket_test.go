...
func TestSeries_SeriesSortedWithoutReplicaLabels(t *testing.T) {
	tests := map[string]struct {
		...
		"use TSDB label as replica label": {
			...
			expectedSeries: []labels.Labels{
				unsortedLabelsFromStrings("a", "1", "ext1", "0", "z", "1"),
				unsortedLabelsFromStrings("a", "1", "ext1", "0", "z", "2"),
				unsortedLabelsFromStrings("a", "1", "ext1", "0", "z", "1"),
				unsortedLabelsFromStrings("a", "1", "ext1", "0", "z", "2"),
				unsortedLabelsFromStrings("a", "1", "ext1", "1", "z", "1"),
				unsortedLabelsFromStrings("a", "1", "ext1", "1", "z", "2"),
				unsortedLabelsFromStrings("a", "2", "ext1", "0", "z", "1"),
				unsortedLabelsFromStrings("a", "2", "ext1", "1", "z", "1"),
			},
		},
