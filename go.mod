...
replace (
	...
	// Pointing to branch merge-pending-prs, commit d3ccf5ceafff592385b3fea3bd0d0767df00a31c
	github.com/thanos-community/promql-engine => github.com/fpetkovski/promql-engine v0.0.0-20230329095152-d3ccf5ceafff
